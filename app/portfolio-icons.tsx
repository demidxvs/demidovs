export function CartIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      <path d="M3 4h2l2.2 10.2a2 2 0 0 0 2 1.6h7.9a2 2 0 0 0 2-1.6L22 7H7" />
...
export function BotIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      ...
      <path d="M8 20v-3m8 3v-3M9 11h.01M15 11h.01" />
    </svg>
  );
}
...
export function DumbbellIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M6.5 9.5v5M9 8v8M15 8v8M17.5 9.5v5" />
      <path d="M9 12h6" />
...
export function DatabaseAtomIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
      <ellipse cx="8" cy="8" rx="6" ry="3" />
      <ellipse cx="8" cy="8" rx="6" ry="3" transform="rotate(60 8 8)" />
      <ellipse cx="8" cy="8" rx="6" ry="3" transform="rotate(-60 8 8)" />
    </svg>
  );
}
...
export function QuestionCodeIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" aria-hidden="true">
      <circle cx="12" cy="12" r="9" />
      <path d="M9 9a3 3 0 1 1 5 2c-1.2 1-2 1.3-2 3M12 17v.5" />
    </svg>
  );
}
...
export function DemidovsMarkIcon() {
  return (
    <svg viewBox="0 0 160 160" fill="none" aria-hidden="true">
      <g stroke="currentColor" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M65 65 45 80l20 15" />
        <path d="M95 65 115 80 95 95" />
        <path d="M78 60 82 100" />
      </g>
    </svg>
  );
}
